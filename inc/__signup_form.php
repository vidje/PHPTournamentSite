<div class="signup">
  <form action="signup.php?id=<?=$_GET['id'];?>" method="post">
    <ul class="flex-teaminfo">
      <li><label for="team-name">Team name</label><input id="team-name" name="team-name" type="text" required></li>
      <li><label for="p1">Team captain (Player 1)</label><input id="p1" name="p1" type="text" required></li>
      <li><label for="contact">Captain e-mail</label><input id="contact" name="contact" type="email" required></li>
    </ul>
    <ul class="flex-teaminfo">
